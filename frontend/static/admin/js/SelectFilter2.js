	...
	window.SelectFilter = {
		init: function (field_id, field_name, is_stacked) {
			...
			quickElement(
				...
				"title",
				interpolate(gettext("This is the list of available %s. You may choose some by " + "selecting them in the box below and then clicking the " + '"Choose" arrow between the two boxes.'), [
					field_name
				])
			);
			...
			quickElement(
				...
				"help help-tooltip help-icon",
				"title",
				interpolate(gettext("This is the list of chosen %s. You may remove some by " + "selecting them in the box below and then clicking the " + '"Remove" arrow between the two boxes.'), [
					field_name
				])
			);
