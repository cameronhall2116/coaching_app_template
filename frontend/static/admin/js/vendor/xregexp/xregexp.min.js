...
(function (H) {
	"object" === typeof exports && "undefined" !== typeof module
		...
		? define([], H)
		: (("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).XRegExp = H());
})(function () {
				...
				function (d, g, p) {
					g.exports = function (c) {
						...
						c.build = function (b, k, g) {
							...
							var h = {},
								w;
							for (w in k) k.hasOwnProperty(w) && ((m = B(k[w], y)), (h[w] = { pattern: A(m.source), names: m.xregexp.captureNames || [] }));
							b = B(b, y);
							var x = 0,
								v,
								q = 0,
				...
				function (d, g, p) {
					g.exports = function (c) {
						...
						c.addUnicodeData([
							...
							{ name: "Glagolitic", bmp: "\u2c00-\u2c2e\u2c30-\u2c5e", astral: "\ud838[\udc00-\udc06\udc08-\udc18\udc1b-\udc21\udc23\udc24\udc26-\udc2a]" },
							{ name: "Gothic", astral: "\ud800[\udf30-\udf4a]" },
							{
								name: "Grantha",
								astral: "\ud804[\udf00-\udf03\udf05-\udf0c\udf0f\udf10\udf13-\udf28\udf2a-\udf30\udf32\udf33\udf35-\udf39\udf3c-\udf44\udf47\udf48\udf4b-\udf4d\udf50\udf57\udf5d-\udf63\udf66-\udf6c\udf70-\udf74]"
							...
							{ name: "Malayalam", bmp: "\u0d01-\u0d03\u0d05-\u0d0c\u0d0e-\u0d10\u0d12-\u0d3a\u0d3d-\u0d44\u0d46-\u0d48\u0d4a-\u0d4f\u0d54-\u0d63\u0d66-\u0d7f" },
							...
							{ name: "Miao", astral: "\ud81b[\udf00-\udf44\udf50-\udf7e\udf8f-\udf9f]" },
							{ name: "Modi", astral: "\ud805[\ude00-\ude44\ude50-\ude59]" },
							{ name: "Mongolian", bmp: "\u1800\u1801\u1804\u1806-\u180e\u1810-\u1819\u1820-\u1877\u1880-\u18aa", astral: "\ud805[\ude60-\ude6c]" },
							{ name: "Mro", astral: "\ud81a[\ude40-\ude5e\ude60-\ude69\ude6e\ude6f]" },
							{ name: "Multani", astral: "\ud804[\ude80-\ude86\ude88\ude8a-\ude8d\ude8f-\ude9d\ude9f-\udea9]" },
			...
			9: [
				function (d, g, p) {
							...
							for (E = E.flags; g < k.length; ) {
								do {
									for (var l, m = k, p = E, q = g, r = c, v = b, w = I.length, x = m.charAt(q), y = null; w--; ) {
										var t = I[w];
										if (
											!((t.leadChar && t.leadChar !== x) || (t.scope !== r && "all" !== t.scope) || (t.flag && -1 === p.indexOf(t.flag))) &&
								...
								t
									...
									: ((t = f.exec(k, O[c], g, "sticky")[0]), (d += t), (g += t.length), "[" === t && "default" === c ? (c = "class") : "]" === t && "class" === c && (c = "default"));
							}
					...
					f.addToken = function (a, e, b) {
						...
						I.push({ regex: z(a, { addG: !0, addY: K, isInternalOnly: !0 }), handler: e, scope: b.scope || "default", flag: b.flag, reparse: b.reparse, leadChar: b.leadChar });
					...
					f.exec = function (a, b, c, d) {
						...
						b.xregexp = b.xregexp || {};
						d = b.xregexp[e] || (b.xregexp[e] = z(b, { addG: !0, addY: f, source: u ? b.source + "|()" : void 0, removeY: !1 === d, isInternalOnly: !0 }));
						d.lastIndex = c || 0;
						a = r.exec.call(d, a);
						u && a && "" === a.pop() && (a = null);
					...
					f.replace = function (a, b, c, d) {
						var e = f.isRegExp(b),
							...
							u = b;
						e
							? ((b.xregexp = b.xregexp || {}), (u = b.xregexp[h] || (b.xregexp[h] = z(b, { addG: !!g, removeG: "one" === d, isInternalOnly: !0 }))))
					...
					r.split = function (a, b) {
						...
						f.forEach(c, a, function (a) {
							a.index + a[0].length > g &&
								(d.push(c.slice(g, a.index)), 1 < a.length && a.index < c.length && Array.prototype.push.apply(d, a.slice(1)), (h = a[0].length), (g = a.index + h));
						});
